...
function train_residual_unet!(model, test_name, n, m, f, kappa, omega, gamma,
    ...
    if data_path != ""
        ...
        train_set = generate_random_data!(train_size, n, m, kappa, omega, gamma;
                                                ...
                                                kappa_type=kappa_type, threshold=threshold, kappa_input=kappa_input, kappa_smooth=kappa_smooth, k_kernel=k_kernel, axb=axb, jac=jac, norm_input=norm_input, gmres_restrt=gmres_restrt, same_kappa=true)
    ...
    for iteration in 1:iterations
        ...
        Flux.train!(loss!, Flux.params(model), train_data_loader, RADAM(lr), cb=() -> println("training"))
